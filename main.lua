...
if No_Health_Cap == true then
	require("srscripts.ForYariksDifficult.no_cap_health")
	print("NoHealthCap connected.")
end

if Placeholder_secrets == true then
	require("srscripts.ForYariksDifficult.placeholder")
	print("Placeholder secrets connected.")
end
